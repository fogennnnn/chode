...
const PROVIDERS = {
  ...
  omnimix:      { name:'OmniRoute Auto',     category:'free_noauth', requiresKey:null, qualityScore:95, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/best-coding', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/best-coding',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnibestfree: { name:'OmniRoute Best Free',category:'free_noauth', requiresKey:null, qualityScore:93, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/best-free', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/best-free',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnicodefree: { name:'OmniRoute Code Free',category:'free_noauth', requiresKey:null, qualityScore:91, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/coding:free', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/coding:free',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  // OmniRoute tiered models
  omnibest:     { name:'OmniRoute Best',     category:'free_noauth', requiresKey:null, qualityScore:90, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/best-coding', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/best-coding',messages:m,max_tokens:8192}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnireason:   { name:'OmniRoute Reason',   category:'free_noauth', requiresKey:null, qualityScore:88, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/best-reasoning', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/best-reasoning',messages:m,max_tokens:8192}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnifast:     { name:'OmniRoute Fast',     category:'free_noauth', requiresKey:null, qualityScore:85, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/best-fast', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/best-fast',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnichat:     { name:'OmniRoute Chat',     category:'free_noauth', requiresKey:null, qualityScore:82, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/best-chat', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/best-chat',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnichaos:    { name:'OmniRoute Chaos',    category:'free_noauth', requiresKey:null, qualityScore:75, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/chaos', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/chaos',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  // OmniRoute specific models
  omniglm:      { name:'OmniRoute GLM',      category:'free_noauth', requiresKey:null, qualityScore:80, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/glm', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/glm',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnigemini:   { name:'OmniRoute Gemini',   category:'free_noauth', requiresKey:null, qualityScore:84, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/gemini', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/gemini',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnillama:    { name:'OmniRoute Llama',    category:'free_noauth', requiresKey:null, qualityScore:78, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/llama', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/llama',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  omnimimo:     { name:'OmniRoute MiMo',     category:'free_noauth', requiresKey:null, qualityScore:76, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'auto/mimo', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'auto/mimo',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  ...
  aug:          { name:'Auggie (OmniRoute)',category:'free_noauth', requiresKey:null, qualityScore:92, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'aug/sonnet4.6', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'aug/sonnet4.6',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  tllm:         { name:'The Old LLM',      category:'free_noauth', requiresKey:null, qualityScore:85, endpoints:[{ type:'chat', url:'https://theoldllm.com/api/chat', model:'tllm/GPT_5_4', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'tllm/GPT_5_4',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  oc:           { name:'OpenCode Free',    category:'free_noauth', requiresKey:null, qualityScore:80, endpoints:[{ type:'chat', url:'https://opencode.ai/api/chat', model:'oc/deepseek-v4-flash-free', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'oc/deepseek-v4-flash-free',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  ...
  agentrouter:  { name:'AgentRouter',      category:'free_noauth', requiresKey:null, qualityScore:88, endpoints:[{ type:'chat', url:p=>`http://localhost:${p||OMNIROUTE_PORT}/api/v1/chat/completions`, model:'agentrouter/claude-opus-4-6', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'agentrouter/claude-opus-4-6',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  felo:         { name:'Felo AI',          category:'free_noauth', requiresKey:null, qualityScore:70, endpoints:[{ type:'chat', url:'https://felo.ai/api/chat', model:'felo/felo-chat', headers:()=>({ 'Content-Type':'application/json' }), body:(k,m)=>JSON.stringify({model:'felo/felo-chat',messages:m,max_tokens:4096}), parse:d=>d.choices?.[0]?.message?.content }] },
  // ── API key providers ──
